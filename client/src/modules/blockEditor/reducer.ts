...
const initialState = {
    hoveredItem: { hoverItemType: null, id: null, top: null, left: null, readOnly: null, blockId: null },
    pointerReferences: {},
};
export const blockEditorReducer = (state = initialState, action) => {
    switch (action.type) {
        case CHANGE_HOVERED_ITEM:
            ...
            return { ...state, hoveredItem: { id, hoverItemType, top, left, readOnly, blockId } };
