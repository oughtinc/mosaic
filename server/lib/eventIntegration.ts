function addEventAssociations(model, models) {
  model.CreatedAtEvent = model.belongsTo(models.Event, {
    as: "createdAtEvent",
    foreignKey: "createdAtEventId"
  });
  model.UpdatedAtEvent = model.belongsTo(models.Event, {
    as: "updatedAtEvent",
    foreignKey: "updatedAtEventId"
  });
}
